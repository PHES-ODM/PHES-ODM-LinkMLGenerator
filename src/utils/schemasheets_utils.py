...
def make_linkml_schema_from_schemasheets(schemasheets_dir: Union[str, Path], output_schema: Union[str, Path], enum_maps: Dict[str, List[str]] = None) -> SchemaDefinition:
