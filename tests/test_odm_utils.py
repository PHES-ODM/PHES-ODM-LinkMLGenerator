...
def test_enum_name_not_in_recognized_returns_string():
    assert odm_get_enum_name_from_part_id("sample", recognized_enums=["other"]) == "string"


def test_enum_name_in_recognized_returns_name():
    assert odm_get_enum_name_from_part_id("sample", recognized_enums=["samples"]) == "samples"
