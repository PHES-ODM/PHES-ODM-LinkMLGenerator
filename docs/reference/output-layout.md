...
[why the intermediate files are kept](../explanation/pipeline-design.md#why-the-intermediate-files-are-kept)
...
`clear_dirs` at the start of a full run. A [partial
re-run](../how-to/run-a-single-pipeline-step.md) does not clear anything.
